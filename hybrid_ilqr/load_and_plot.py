...
if __name__ == '__main__':
    ...
    # save figures
    fig1.savefig(root_dir+'/hybrid_pathintegral/bouncing_1D.pdf', format='pdf', dpi=2000)
    ...
    ax5.legend()
    fig2.tight_layout()
    fig2.savefig(root_dir+'/hybrid_pathintegral/bouncing_1D_zdotz.pdf', format='pdf', dpi=2000)
    ...
    fig3.tight_layout()
    fig3.savefig(root_dir+'/hybrid_pathintegral/bouncing_1D_costs.pdf', format='pdf', dpi=2000)
    ...
    fig4.savefig(root_dir+'/hybrid_pathintegral/bouncing_1D_var.pdf', format='pdf', dpi=2000)
    fig5.savefig(root_dir+'/hybrid_pathintegral/bouncing_1D_lbda.pdf', format='pdf', dpi=2000)
